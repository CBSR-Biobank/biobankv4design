...
%
%  EnableStudyCommand & studyId & Used to enable a study. Once enabled the study
%  is ready to collect and process specimens from participants.  See
%  \entitylink{Study} for more details on the argument. \\
%
%  DisableStudyCommand & studyId & Used to disable a study. A study may be
%  disabled because no more specimen collection will be done with it, or because
%  it requires configuration changes. Once disabled the study can no longer
%  collect and / or process specimens from participants. See \entitylink{Study}
%  for more details on the argument. \\
%
%  CreateSpecimenGroupCommand & \parbox[t]{1.8cm}{studyId,\\ name,
%    \\description,\\ anatomicalSourceId,\\preservationId,\\specimenTypeId} &
%  Used to create a specimen group for a study. See \entitylink{SpecimenGroup}
%  for more details on the argument. \\
