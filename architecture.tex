...
view of the application. It is the architecture recommended by the Eventsourced
Framework.
...
expresses its intent by its name. In Scala terms, that means the class name is
...
these repositories are optimized for look up of an aggregate by its unique
